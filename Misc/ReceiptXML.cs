...
public class ReceiptXML
{
    ...
    public List<CheckPay.Payment> PaymentList { get; set; }
    #endregion

    #region CheckTax properties
    public List<CheckTax.Tax> TaxList { get; set; }
    #endregion

    #region CheckBody propperties
    public List<CheckBody.Body> BodyList { get; set; }
    ...
    public static string SerializeToXMLString(CheckBuilder checkBuilder)
    {
        ...
        using (MemoryStream ms = new MemoryStream())
        {
            ...
            {
                XmlSerializer s = new XmlSerializer(typeof(ReceiptXML.CheckBuilder));
